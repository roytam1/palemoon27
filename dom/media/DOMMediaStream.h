...
public:
  ...
  DOMMediaStream(nsPIDOMWindow* aWindow,
...
public:
  DOMAudioNodeMediaStream(nsPIDOMWindow* aWindow, AudioNode* aNode);
...
public:
  explicit DOMHwMediaStream(nsPIDOMWindow* aWindow);

  static already_AddRefed<DOMHwMediaStream> CreateHwStream(nsPIDOMWindow* aWindow,
