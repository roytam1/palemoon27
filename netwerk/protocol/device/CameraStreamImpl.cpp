...
extern "C" {
    NS_EXPORT void JNICALL Java_org_mozilla_gecko_GoannaAppShell_cameraCallbackBridge(JNIEnv *, jclass, jbyteArray data);
}

NS_EXPORT void JNICALL
Java_org_mozilla_gecko_GoannaAppShell_cameraCallbackBridge(JNIEnv *env, jclass, jbyteArray data) {
...
void CameraStreamImpl::Close() {
    mozilla::widget::GoannaAppShell::CloseCamera();
    mCallback = nullptr;
}
