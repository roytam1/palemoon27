                                              ...
                                              bool* aIsSubtreeHidden)
{
  ...
  if (!newAcc) {
    if (content->IsSVG()) {
      ...
      if (!newAcc && !(content->Tag() == nsGkAtoms::mpadded_ ||
                       content->Tag() == nsGkAtoms::mphantom_ ||
                       content->Tag() == nsGkAtoms::maligngroup_ ||
                       content->Tag() == nsGkAtoms::malignmark_ ||
                       content->Tag() == nsGkAtoms::mspace_)) {
