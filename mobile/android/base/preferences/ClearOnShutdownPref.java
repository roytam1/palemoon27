...
public class ClearOnShutdownPref implements GoannaPreferences.PrefHandler {
    public static final String PREF = GoannaPreferences.NON_PREF_PREFIX + "history.clear_on_exit";
