...
!macro ResetWin8PromptKeys KEY PREFIX
  ${If} ${AtLeastWin8}
    DeleteRegValue ${KEY} "${PREFIX}Software\Microsoft\Windows\CurrentVersion\ApplicationAssociationToasts" "ArcticFoxHTML_.htm"
    DeleteRegValue ${KEY} "${PREFIX}Software\Microsoft\Windows\CurrentVersion\ApplicationAssociationToasts" "ArcticFoxHTML_.html"
    DeleteRegValue ${KEY} "${PREFIX}Software\Microsoft\Windows\CurrentVersion\ApplicationAssociationToasts" "ArcticFoxHTML_.xht"
    DeleteRegValue ${KEY} "${PREFIX}Software\Microsoft\Windows\CurrentVersion\ApplicationAssociationToasts" "ArcticFoxHTML_.xhtml"
    DeleteRegValue ${KEY} "${PREFIX}Software\Microsoft\Windows\CurrentVersion\ApplicationAssociationToasts" "ArcticFoxHTML_.shtml"
    DeleteRegValue ${KEY} "${PREFIX}Software\Microsoft\Windows\CurrentVersion\ApplicationAssociationToasts" "ArcticFoxURL_ftp"
    DeleteRegValue ${KEY} "${PREFIX}Software\Microsoft\Windows\CurrentVersion\ApplicationAssociationToasts" "ArcticFoxURL_http"
    DeleteRegValue ${KEY} "${PREFIX}Software\Microsoft\Windows\CurrentVersion\ApplicationAssociationToasts" "ArcticFoxURL_https"
  ${EndIf}
!macroend
...
!macro RemoveDEHRegistration DELEGATE_EXECUTE_HANDLER_ID \
  ...
  ${Do}
    ...
    ${Else}
      ; misc. Metro keys
      DeleteRegKey HKU "$1\Software\Mozilla\${BrandFullNameInternal}\Metro"
      DeleteRegValue HKU "$1\Software\Mozilla\${BrandFullNameInternal}" "CEHDump"
      DeleteRegValue HKU "$1\Software\Mozilla\${BrandFullNameInternal}" "MetroD3DAvailable"
      DeleteRegValue HKU "$1\Software\Mozilla\${BrandFullNameInternal}" "MetroLastAHE"
