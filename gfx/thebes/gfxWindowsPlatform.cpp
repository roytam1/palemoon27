...
gfxWindowsPlatform::InitializeD3D9Config()
{
  ...
  if (!IsGfxInfoStatusOkay(nsIGfxInfo::FEATURE_DIRECT3D_9_LAYERS)) {
    d3d9.Disable(FeatureStatus::Blacklisted, "Direct3D 9 for layers is blacklisted on this hardware");
  }
